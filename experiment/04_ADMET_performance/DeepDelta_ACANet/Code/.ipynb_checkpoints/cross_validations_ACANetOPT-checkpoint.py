...
for prop in properties:
    ...
    for model in models:
        ...
        for i in range(5): # Allow for 5x10-fold cross validation
            ...
            pd.DataFrame(results).to_csv("../Results/ACANetOPT/{}_{}_{}.csv".format(prop, str(model), i), index=False) # Save results
            ...
            df = pd.read_csv("../Results/ACANetOPT/{}_{}_{}.csv".format(prop, model, i)).T
        ...
        delta.to_csv("../Results/ACANetOPT/{}_{}_delta_scoring.csv".format(prop, model)) # Save data