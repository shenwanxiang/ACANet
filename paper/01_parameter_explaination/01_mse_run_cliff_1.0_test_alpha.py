...
from clsar.model.saver import SaveBestModel # model saver
...
for dataset_name in Dataset.names.keys():
    ...
    for alpha in weights:
        ...
        for j in range(n_repeats):        
            for i in range(n_folds):
                ...
                #                       save_dir = './tmpignore/%s_model' % dataset_name, 
                #                       save_name = 'model_%s.pth' % i)
