...
class HSSMS(LSSNS):
    ...
    Args:
        ...
        pre_filter (callable, optional): A function that takes in an
            ...
            final dataset. (default: :obj:`None`)
    """
    url = 'https://raw.githubusercontent.com/bidd-group/MPCD/main/dataset/HSSMS/MoleculeACE_benchmark/{}'
    meta = 'https://raw.githubusercontent.com/bidd-group/MPCD/main/dataset/HSSMS/MoleculeACE_benchmark/metadata/datasets.csv'
